...
migrations = [
  ...
  migration('profile-data.v37.sql'),
  migration('profile-data.v38.sql'),
  migration('profile-data.v39.sql'),
  migration('profile-data.v40.sql'),
  migration('profile-data.v41.sql'),
  migration('profile-data.v42.sql')
]
